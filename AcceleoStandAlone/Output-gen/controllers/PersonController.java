...
import dto.PersonCriteriaBuilder;
...
public class PersonController extends Controller {
	...
	static Form<Person> searchForm = Form.form(Person.class);
    ...
    public static Result getListpage() {
		searchForm = Form.form(Person.class).bindFromRequest();
        final Person person = searchForm.get();
        final Page page = new Page<>(Person.class, PersonCriteriaBuilder.buildCriteria(person));
        return ok(views.html.person.person_list.render("blank page", page, searchForm.fill(person)));
    ...
    public static Result list(int page) {
        personService = Global.InjectorFactory.getInjector().getInstance(PersonService.class);
        return ok(views.html.person.person_list.render("blank page", personService.getPage(page), searchForm.fill(new Person())));
     }
